...
export const TRANSLATIONS = {
  ru: {
    ...
    menu_help: 'Помощь',
    menu_open_downloads_folder: 'Открыть папку загрузок',
    menu_exit: 'Выход',
  ...
  uk: {
    ...
    menu_help: 'Довідка',
    menu_open_downloads_folder: 'Відкрити папку завантажень',
    menu_exit: 'Вихід',
  ...
  en: {
    ...
    menu_help: 'Help',
    menu_open_downloads_folder: 'Open Downloads Folder',
    menu_exit: 'Exit',
