...
export function DeleteConfirmModal({ title, t, onConfirm, onCancel }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm"
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-900 dark:border dark:border-gray-800"
        ...
        <h2 className="text-center text-base font-semibold text-gray-900 dark:text-gray-100">{t.delete_title}</h2>
